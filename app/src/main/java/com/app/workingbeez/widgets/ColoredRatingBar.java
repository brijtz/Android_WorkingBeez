    ...
    private void init(Context context) {
        ...
        if (mType == SMALL) {
            drawables = new Bitmap[]{
                    ...
                    BitmapFactory.decodeResource(res,
                            R.drawable.ic_star_fill)};
            progressBackground = BitmapFactory.decodeResource(res,
                    R.drawable.ic_star_unfill);
        } else if (mType == MEDIUM) {
            drawables = new Bitmap[]{
                    BitmapFactory.decodeResource(res,
                            R.drawable.ic_star_fill),
                    BitmapFactory.decodeResource(res,
            ...
            drawables = new Bitmap[]{
                    BitmapFactory.decodeResource(res, R.drawable.ic_star_fill),
                    BitmapFactory.decodeResource(res, R.drawable.ic_star_fill),
                    BitmapFactory.decodeResource(res, R.drawable.ic_star_fill)};
            progressBackground = BitmapFactory.decodeResource(res,
                    R.drawable.ic_star_unfill);
